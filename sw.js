const CACHE='aset-wajo-v17-5';
const SHELL=['./','./index.html','./manifest.webmanifest','./assets/logo-wajo.png','./assets/icon-192.png','./assets/icon-512.png','./assets/v17-5.css','./assets/v17-5.js'];
