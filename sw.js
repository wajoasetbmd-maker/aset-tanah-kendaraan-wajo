const CACHE='aset-wajo-v17-7';
const SHELL=['./','./index.html','./manifest.webmanifest','./assets/logo-wajo.png','./assets/icon-192.png','./assets/icon-512.png','./assets/v17-6.css','./assets/v17-6.js','./assets/v17-7-local-first.js','./templates/surat_rekomendasi.html','./templates/tanda_terima_bpkb.html'];
